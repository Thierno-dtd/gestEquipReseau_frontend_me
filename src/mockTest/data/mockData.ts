...
import { 
  ...
  export const mockPorts: Port[] = [
    ...
    ...Array.from({ length: 24 }, (_, i) => ({
      ...
      duplex : i < 12 ? DuplexType.AUTO : DuplexType.FULL,
      speed: '100Mbps',
  ...
  export const mockEquipmentDetails: EquipmentDetail[] = [
    {
      ...mockEquipments.find(eq => eq.id = 'equip-4')!,
      rack: mockRacks.find(r => r.id === 'rack-2')!,
      ports: [
        {
          id: 'port-1-1',
          equipmentId: "EQ-001",
    ...
    {
      ...mockEquipments.find(eq => eq.id = 'equip-3')!,
      rack: mockRacks.find(r => r.id === 'rack-1')!,
      ports: [],
      connections: [],
  ...
  export const mockPortDetails: PortDetail[] = [
    {
      ...mockPorts.find(p => p.id = 'port-1-1')!,
      equipment: mockEquipments.find(eq => eq.id = 'equip-4')!,
      connectedPort: mockPorts.find(p => p.id = 'conn-1')!,
      connection: mockConnections.find(c => c.id = 'conn-1')!,
    },
    {
      ...mockPorts.find(p => p.id = 'port-1-2')!,
      equipment: mockEquipments.find(eq => eq.id = 'equip-1')!,
      connectedPort: mockPorts.find(p => p.id = 'conn-1')!,
      connection: mockConnections.find(c => c.id = 'conn-1')!,
    },
  ];
